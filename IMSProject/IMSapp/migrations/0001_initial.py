    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CourseImage', models.ImageField(null=True, upload_to='media/courseImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Imsuser', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='teacherinfo', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='StudentModel',
            fields=[
                ...
                ('StudentPhoto', models.ImageField(null=True, upload_to='media/studentPhoto')),
                ...
                ('GithubLink', models.CharField(max_length=150, null=True)),
                ('FacebookLink', models.CharField(max_length=150, null=True)),
                ('Imsuser', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='studentinfo', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='StaffModel',
